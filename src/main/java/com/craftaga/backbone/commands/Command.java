...
package com.craftaga.backbone.commands;
...
public interface Command<ParamType, ReturnType> {
    ...
    /**
     * Execute command with ParamType and return ReturnType
     */
    public ReturnType execute(final ParamType params) throws Exception;
}
